function place() {
    let place = Math.floor(Math.random() * 71)
    return place;
}
...
.bindPopup("<b>Station : Saint-jean-de-Védas Mairie centre </b><br /> Places Total : 7 libre : "+ place() +" <br /> <img src='https://www.actu-environnement.com/images/illustrations/breve/37088_large.jpg' alt='image de station' height='150px' width='250'> ").openPopup();
